...
'''toy_dctcp_graph.add_edge(3, 4)
toy_dctcp_graph.add_edge(5, 6)
toy_dctcp_graph.add_edge(7, 8)
toy_dctcp_graph.add_edge(9, 10)
toy_dctcp_graph.add_edge(0, 3)
toy_dctcp_graph.add_edge(0, 5)
toy_dctcp_graph.add_edge(0, 7)
toy_dctcp_graph.add_edge(1, 7)
toy_dctcp_graph.add_edge(1, 9)
toy_dctcp_graph.add_edge(2, 8)
toy_dctcp_graph.add_edge(2, 6)
toy_dctcp_graph.add_edge(2, 4)
toy_dctcp_graph.add_edge(2, 10)'''
toy_dctcp_graph.add_edge(0, 2)
toy_dctcp_graph.add_edge(0, 4)
toy_dctcp_graph.add_edge(0, 6)
toy_dctcp_graph.add_edge(0, 8)
toy_dctcp_graph.add_edge(2, 3)
toy_dctcp_graph.add_edge(4, 5)
toy_dctcp_graph.add_edge(6, 7)
toy_dctcp_graph.add_edge(8, 9)
