...
void hostNode::handleTriggerPriceQueryMessage(routerMsg* ttmsg){
   ...
   for (auto it = destNodeToNumTransPending.begin(); it!=destNodeToNumTransPending.end(); it++){
       if (it->first == myIndex()) continue; //TODO: fix this error
