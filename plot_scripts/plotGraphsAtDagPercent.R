...
# add a line plot
succ_ratio_plot <- ggplot(data[data$Scheme != "Circ",],
                          aes_string(x="DAGAmt",y="SuccRatio", colour="Scheme", shape="Scheme")) +
        geom_line(size=1) +
        geom_point(size=3) +
        geom_errorbar(aes_string(ymin="SuccRatioMin", ymax="SuccRatioMax"), width=2) +
...
# add a line plot
succ_volume_plot <- ggplot(data, aes_string(x="DAGAmt",y="SuccVolume", colour="Scheme", shape="Scheme", 
                                            linetype="Scheme")) +
        geom_line(size=1) +
        geom_point(size=3) +
        geom_errorbar(aes_string(ymin="SuccVolumeMin", ymax="SuccVolumeMax"), width=2) +
        scale_x_continuous(expand=c(0,0)) +
        coord_cartesian(xlim=c(-1,limit),ylim=c(0,100)) +
